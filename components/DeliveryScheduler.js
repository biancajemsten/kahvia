  ...
  return (
    <div className="c-delivery-scheduler">
      ...
      <Row className="c-delivery-scheduler__row">
        ...
        <Col span={8}>
        <DatePicker onChange={(date, dateString) => setChosenDate(dateString)} />
        </Col>
      </Row>
      <Row className="c-delivery-scheduler__row">
          <Col span={16}>
        ...
        <Col span={8}>
        <TimePicker onChange={(value, valueString) => setFromTime(valueString)}/>
        </Col>
      </Row>
      <Row className="c-delivery-scheduler__row">
          <Col span={16}>
        ...
        <Col span={8}>
        <TimePicker onChange={(value, valueString) => setToTime(valueString)}/>
        </Col>
      </Row>
      <Row className="c-delivery-scheduler__row">
      {chosenDate.length > 0 && !fromTime && !toTime &&
       ...
       {chosenDate.length > 0 && fromTime.length > 0 && !toTime &&
          <Text>Your delivery will be {chosenDate}, {fromTime}</Text>
      }
      {chosenDate.length > 0 && fromTime.length > 0 && toTime &&
          <Text>Your delivery will be {chosenDate}, {fromTime} - {toTime}</Text>
      }
    </Row>
    <Row>
    <Title className="c-delivery-scheduler__title">
